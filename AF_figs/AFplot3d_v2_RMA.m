...
function [h_fig, slp, int, r2, nonan] =  AFplot3d_v2_RMA(...
...
% Calculate linear regression using Reduced Major Axis (RMA)
[~,~,beta1] = rSMA(data_scat_mn(index_nonnan1),data_scat_cs1(index_nonnan1));
...
% Calculate linear regression using Reduced Major Axis (RMA)
[~,~,beta2] = rSMA(data_scat_mn(index_nonnan2),data_scat_cs2(index_nonnan2));

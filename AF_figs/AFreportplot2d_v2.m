function [] = AFreportplot2d_v2(main, comp)  
...
for i = 2:size(mn_data,2)
    ...
    elseif isnan(minval)~=1 && isnan(maxval)~=1
        ...
        if numel(comp) == 2
            %%
            [h_fig, slp(i), int(i), r2(i), nonan(i)] = AFplot3d(...
                mn_lab, i, date_num_mn, mn_data, ...
                c1_lab, i, date_num_c1, c1_data, ...
                c2_lab, i, date_num_c2, c2_data, ...
                header{i,1}, header{i,2}, ...
                mn_lmt, c1_lmt, c2_lmt, [minval maxval]);
        else
            %%
            [h_fig, slp(i), int(i), r2(i), nonan(i)] = AFplot2d(...
                mn_lab, i, date_num_mn, mn_data, ...
                c1_lab, i, date_num_c1, c1_data, ...
                header{i,1}, header{i,2}, ...
                mn_lmt, c1_lmt, [minval maxval]);
        end
        ...
        export_fig(['figures/' foldout '/' namstrg],'-png', '-pdf', '-eps', '-nocrop')
        close (h_fig);
    end

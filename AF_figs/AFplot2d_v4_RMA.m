function [h_fig, slp, int, r2, nonan] =  AFplot2d_v4_RMA(ps_string,ps_col,datetime_num_ps,data_corr_ps,unca_corr_ps,cs_string,cs_col,datetime_num_cs,data_corr_cs,...
...
[~,~,beta] = rSMA(data_scat_ps(index_nonnan),data_scat_cs(index_nonnan));
